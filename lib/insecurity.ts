...
// IMPORTANT: In production, set the JWT_PRIVATE_KEY environment variable to a secure value
// This hardcoded key is only for development/testing purposes
...
// IMPORTANT: In production, set the HMAC_KEY environment variable to a secure value
// This hardcoded key is only for development/testing purposes
const hmac_key = process.env.HMAC_KEY || "pa4qacea4VK9t9nGv7yZtwmj";
  crypto.createHash("md5").update(data).digest("hex");
const hmac_key = "pa4qacea4VK9t9nGv7yZtwmj";
