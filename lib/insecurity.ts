...
// SECURITY: These keys should be set via environment variables in production
// Set JWT_PRIVATE_KEY and HMAC_KEY environment variables to override default values
